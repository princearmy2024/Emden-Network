...
window.CURRENT_VERSION = '1.3.3'; // Stand: 28.03.2026 (Pro Radio: Global PTT, Mic-Direct Monitoring)
...
const App = {
    ...
    // --- INIT ---
    async init() {
        console.log(`[App] Initialisiere Dashboard v1.3.3...`);
        ...
        try {
            ...
            if (splashVer) splashVer.textContent = `Control Center v1.3.3`;
